...
“”“
// Obtain the intersection percentage of 2 circles, the radius of circle A is known as r1, the radius of circle B is r2, the distance between the centers of the two circles is d, and the ratio of the area of ​​the intersection of the two circles to the area of ​​circle A is returned
...
class Sector( Area ):
	...
	def inArea( self, caster, entity, transmitDir ):
		"""
		Whether the entity is within the sector
		"""
		...
		if an == 0:	 # Happens to be in the same position as the caster
			an = 1
		...
		if angle <= self.angle:	# Less than or equal to the included angle
			return True
