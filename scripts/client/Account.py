...
class Account(KBEngine.Entity):
	...
	def reqRemoveAvatar(self, name):
		"""
		"""
		#name = json.loads(strargs)
		DEBUG_MSG("Account:reqRemoveAvatar::name=%s" % (name))
		self.base.reqRemoveAvatar(name)
		DEBUG_MSG("Account:reqRemoveAvatar::name=%s - Removed" % (name))
	...
	def ping(self, strargs):
		"""
		"""
		par1, par2 = json.loads(strargs)
		DEBUG_MSG("Account:ping::par1=%s, par2=%s" % (par1, par2))
