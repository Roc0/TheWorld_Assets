...
if %errorlevel%==1 start "KBE baseapp KBE" "%KBE_BIN_PATH%/baseapp.exe" --cid=7001 --gus=7
...
rem if %errorlevel%==1 start "KBE cellapp KBE" "%KBE_BIN_PATH%/cellapp.exe" --cid=8001 --gus=9
