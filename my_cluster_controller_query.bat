...
if defined KBE_ROOT (%PYTHON% "%KBE_ROOT%/kbe\tools\server\pycluster\cluster_controller.py" query %uid%) else (%PYTHON% "..\kbe\tools\server\pycluster\cluster_controller.py" query %uid%)
