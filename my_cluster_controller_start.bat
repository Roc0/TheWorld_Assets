...
if defined KBE_ROOT (%PYTHON% "%KBE_ROOT%/kbe\tools\server\pycluster\cluster_controller.py" start %ip% %uid%) else (%PYTHON% "..\kbe\tools\server\pycluster\cluster_controller.py" start %ip% %uid%)
